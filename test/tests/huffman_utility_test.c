...
bool test_coded_string_equal() {
    ...
    return is_coded_string_equal(coded_string_1, coded_string_1_1, 5) &
           !is_coded_string_equal(coded_string_1, coded_string_2, 5) &
           !is_coded_string_equal(coded_string_1, coded_string_3, 5);
}
